...
exports.BotInputValidate=[
    body('Patient_Name', 'Enter a valid name').notEmpty(),
    body('Patient_email', 'Please Provide valid Email').isEmail(),
    body('Patient_Gender','Please provide valid gender data').notEmpty(),
    body('Patient_DOB','Please provide valid DOB date').notEmpty(),
    body('Patient_Address','Please provide Valid Address Detail').notEmpty(),
    body('Patient_Phone','Please provide valid Phone no').isMobilePhone(),
    body('Patient_Primary_Insurance_Status',"Please Enter Valid Primary Insurance Status").notEmpty(),
    ...
    body('Patient_Date_Of_Visit','Please provide valid date of visit').notEmpty(),
